...
namespace Soloco.EventStore.MeasurementProjections.MeasurmentReadCounter
{
    internal class Example
    {
        ...
        public Example(MeasurementReadCounterProjection measurementReadCounterProjection, MeasurementReadCounterQuery measurementReadCounterQuery, EventReader eventReader, DeviceSimulator deviceSimulator, IColorConsole console)
        {
